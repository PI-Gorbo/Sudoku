...
'                    Cells(Rows, Cols).CalcCandidates.Clear()
...
'                        For i = 1 To 9
'                            Cells(Rows, Cols).CalcCandidates.Add(i)
'                        Next
'                    Else
...
'                c.CalcCandidates.Remove(_Cell.Value)
'            End If
'        Next
...
'                Cells(_Cell.CellLocation.Y, Cols).CalcCandidates.Remove(_Cell.Value)
'            End If
'        Next
...
'                Cells(Rows, _Cell.CellLocation.X).CalcCandidates.Remove(_Cell.Value)
'            End If
'        Next
